...
import com.esc.crm.app.controller.fake.FakeNode;
...
//  }
    public ResponseEntity<HashMap<Object, Object>> login(@RequestBody SigninRequest request) {
        FakeNode node = new FakeNode(userService.signin(request.getUsername(), request.getPassword()));
